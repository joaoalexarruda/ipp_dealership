...
urlpatterns = [
    ...
    path('motorcycles/<int:pk>/', MotorcycleDetailView.as_view(),
         name='motorcycle_detail'),
    path('motorcycles/<int:pk>/update/', MotorcycleUpdateView.as_view(),
         name='motorcycle_update'),
    path('motorcycles/<int:pk>/delete/', MotorcycleDeleteView.as_view(),
         name='motorcycle_delete'),
    path('motorcycles/create/', MotorcycleCreateView.as_view(),
